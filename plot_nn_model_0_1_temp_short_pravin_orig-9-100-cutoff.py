...
testinput = testinput.reshape(len(testinput), 4, 19)
...
# Create the model
model=Sequential()
model.add(Conv1D(filters=20, kernel_size=4, padding='valid', activation='relu', strides=1, input_shape=(19, 4)))
...
adam = Adam()       # Higher values get steep loss curves ..
...
model.save("D:\\model_mychar20_9.h5")
