...
# load array
X_train_whole = loadtxt('d:\\myflashes50.csv', delimiter=',')
...
#steps = [('pca', PCA(n_components=15)), ('svc', SVC(C=10.0, degree=5, kernel='poly', verbose=True, class_weight={0: 2, 1: 1}))]  # ('m', GaussianNB())
